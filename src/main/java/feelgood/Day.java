...
public class Day {
    ...
    public boolean equals(Object obj) {
        if (this == obj) // Sjekker at det er samme objekt, (aka, Day - objektet)
            return true;
        if (obj == null) // Hvis objektet er null vet vi at det ikke er det samme, returnerer false
            return false;
        ...
        // Sammenligner alle feltene, blir returnert false hvis noen av de ikke er like
